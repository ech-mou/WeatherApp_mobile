package com.example.tutorialweatherapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String API_KEY = "c1269f0c761ea87f38c2c89457aae995";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(city.isEmpty())
                    Toast.makeText(MainActivity.this,"Please entrer a city name",Toast.LENGTH_SHORT).show();
                else {
